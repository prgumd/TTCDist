###############################################################################
#
# File: ros_convert_rovio.py
#
# Record rovio output to a npy file for comparison
#
# History:
...
if __name__ == '__main__':
    ...
    if not args.allspeed:
        ...
        poses = []
        message_t = []
        for topic, odom, t in bag.read_messages(topics=['/rovio/odometry']):
        ...
        bags = sorted(glob.glob('results/record_*/rovio/*.bag'))
